...
try:
    ...
    ImageInstanceNavigationOrchestrator = insnav_main.ImageInstanceNavigationOrchestrator
    
except ImportError as e:
    print(f"Fatal: Could not import ImageInstanceNavigationOrchestrator from main.py: {e}")
    print(f"Checked path: {insnav_preprocess_root / 'main.py'}")
    print("Please ensure main.py is in the correct path (insnav_preprocess/).")
    sys.exit(1)
...
class EpisodeEvaluator:
    ...
    def __init__(self, config_path: str):
        ...
        if 'output_dir' in self.config:
            ...
            self.output_dir = self.project_root / "insnav_eval" / "output" / self.scene_id
    ...
    def _create_preprocess_config(self, episode_data: Dict[str, Any]) -> Path:
        ...
        try:
            ...
            # Fix episodes_file to point to the actual JSON file
            insnav_config["scene_config"]["episodes_file"] = self.config['episode']['episode_json_path']
    ...
    def _run_preprocessing(self, preprocess_config_path: Path) -> bool:
        ...
        try:
            ...
            orchestrator = ImageInstanceNavigationOrchestrator(str(preprocess_config_path))
