...
sys.path.insert(0, "/home/yaoaa/habitat-lab/yolov7/")
try:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights", type=str, default="/data2/awangas/yolov7-e6e.pt", help="YOLOv7 weights path")
    ...
    yolov7 = YOLOv7Server(args.weights)
