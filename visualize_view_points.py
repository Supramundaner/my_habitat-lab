...
def main():
	...
	parser.add_argument("--episodes", default="/home/yaoaa/habitat-lab/data/datasets/objectnav/hm3d/v1/val/content_preprocessed/5cdEh9F2hJL.json", help="Path to the episodes JSON file for the scene")
	...
	parser.add_argument("--object_id", default="sofa_400", help="Target object_id to visualize")
