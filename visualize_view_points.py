...
def main():
	...
	parser.add_argument("--episodes", default="/home/yaoaa/habitat-lab/data/datasets/ovon/hm3d/val_seen/content/y9hTuugGdiq.json", help="Path to the episodes JSON file for the scene")
	parser.add_argument("--scene", default="/home/yaoaa/habitat-lab/data/versioned_data/hm3d-0.2/hm3d/val/00808-y9hTuugGdiq/y9hTuugGdiq.basis.glb", help="Path to the scene .glb file")
	parser.add_argument("--object_id", default="cabinet_731", help="Target object_id to visualize")
