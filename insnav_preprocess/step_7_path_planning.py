...
def path_planning_step(config: Dict[str, Any], output_dir: str) -> Dict[str, Any]:
    ...
    goal_image_absolute_path = os.path.abspath(goal_image_path)
    print(f"✓ Goal image path resolved: {goal_image_absolute_path}")

    # 5. Assemble the final action.json data for Image-Instance Navigation
    action_data = {
        "agent_state": agent_state,
        "target_info": target_info,
        "wall_mask": wall_mask_absolute_path,
        "goal_image": goal_image_absolute_path,
