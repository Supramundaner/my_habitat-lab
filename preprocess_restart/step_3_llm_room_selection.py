...
def select_room_with_llm(topdown_path: str, room_annotation_path: str, 
    ...
    Args:
        ...
        room_annotation_path: Path to room annotation image (may contain markers from previous iterations)
    ...
    log_filename = f"room_selection_log_iter_{iteration + 1}.json" if iteration > 0 else "room_selection_log.json"
